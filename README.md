...
* **net-wireless/rpi3-wifi-regdom** Thee package is removed: the simplest (with wpa_supplicant) way to set the WiFi regulatory domain is to add "country=\*\*" option to the wpa_supplicant.conf in global section. No module params or other extra configs is need.
